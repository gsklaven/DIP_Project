...
# dist_hist = calculate_hist_of_img(dist, return_normalized=True)
#
...
hist_ref = calculate_hist_of_img(img_array2, return_normalized=True)
modified = perform_hist_modification(img_array, hist_ref, "greedy")
print(modified)
